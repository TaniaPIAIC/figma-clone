      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <div className="mt-6 flex gap-5">
            <button className="bg-cyan-500 hover:bg-cyan-600 text-white px-5 py-2 rounded-md text-sm">
              Learn more
            </button>

            <button className="border border-cyan-500 text-cyan-500 px-5 py-2 rounded-md text-sm hover:bg-cyan-50">
        ...
        <div className="flex justify-center md:justify-end">
          <img
            src={laptopImg}
            alt="solution"
            className="w-[380px] rounded-xl shadow-md"
          />
        </div>
